class INetworkClient:
    """
    All function invocations are expected to be non-blocking.  Calls that block will severely degrade performance.
    Consider offloading blocking calls to a separate thread.
    """
